...
The Reachable CI proof page is the standardized remediation status page
generated by the Reachable wheel helper `python -m reachable.ci.proof_page`. It
is for release managers and reviewers.
...
- expandable DB-backed evidence with three parts:
  ...
  - exploitability rationale for attacked or defended findings
